...
`~/.Codex/agents/`. They are auto-discovered as `subagent_type` values only
...
1. Read the agent definition file: `~/.Codex/agents/<agent-name>.md`
...
```
agent_def = Read("~/.Codex/agents/ux-review.md")  // strip frontmatter
Agent({
  subagent_type: "general-purpose",
...
```
agent_def = Read("~/.Codex/agents/ux-reform.md")  // strip frontmatter
Agent({
  subagent_type: "general-purpose",
...
```
agent_def = Read("~/.Codex/agents/usage-guide-writer.md")  // strip frontmatter
Agent({
  subagent_type: "general-purpose",
...
```
agent_def = Read("~/.Codex/agents/code-tester.md")  // strip frontmatter
Agent({
  subagent_type: "general-purpose",
...
2. Read `~/.Codex/agents/ux-review.md`, strip frontmatter to get the agent body.
...
2. Read `~/.Codex/agents/ux-reform.md`, strip frontmatter to get the agent body.
...
1. Read `~/.Codex/agents/code-tester.md`, strip frontmatter to get the agent body.
...
2. Read `~/.Codex/agents/usage-guide-writer.md`, strip frontmatter to get the agent body.
