---
name: obsidian-notes
description: Use when taking notes, recalling context, building connections, or treating the Obsidian vault as Codex's persistent memory across sessions
---

# Obsidian Notes — Codex's Persistent Memory
...
The vault is Codex's **external brain** — persistent, cross-session memory where thinking accumulates. Each session should leave the vault richer than it found it. Obsidian is the overflow for insight that would otherwise vanish at session end.
...
- [ ] **Future value**: Would a future Codex instance genuinely benefit?
...
**What survives compaction:** AGENTS.md, tasks, memory files, git state, disk files.
